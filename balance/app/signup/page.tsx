...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen -mt-24 -mx-4 sm:-mx-6 lg:-mx-8 flex items-center justify-center bg-gradient-to-br from-[#004d36] via-[#006f4e] to-[#00956a] relative overflow-hidden py-8">
      {/* Decorative circles */}
